...
//BOUTON partager
	...
	$('#annulerpopPartager').click(function(){
		$("#popPartager").hide();
	});

	$('#validerpopPartager').click(function(){
		arrayNewDocument["confident"]= $('input[name=optionsRadios]:checked', '#popPartager').val();
...
//BOUTON Creer titre Document
	...
	$("#validerTitreDoc").click(function(){
		...
		arrayNewDocument["confident"] = "privee";
...
//BOUTON Ajouter Une Reponse
	...
	if($(divQuestionCourant).find("#inputtitreExo").val() == ""){
